        ...
        <SafeAreaView>
            <ScrollView>
                ...
                <View style={styles.prod}>
                    <Image source={require('../assets/tools1.png')} style={styles.image} />
                ...
                <View style={styles.prod}>
                    <Image source={require('../assets/tools2.png')} style={styles.image} />
                    <View style={{ flexDirection: 'column', paddingLeft: 30 }}>
                        <Text style={{ color: 'black', fontSize: 16, padding: 10 }}>
                            Lorem Ipsum has been
                        </Text>
                ...
                <View style={styles.prod}>
                    <Image source={require('../assets/tools3.png')} style={styles.image} />
                    <View style={{ flexDirection: 'column', paddingLeft: 30 }}>
                        <Text style={{ color: 'black', fontSize: 16, padding: 10 }}>
                            Lorem Ipsum has been
                        </Text>
